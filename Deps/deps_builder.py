...
def main():
    deps = [
        ("KrayoDeps", "lkCommon"),
        ("KrayoDeps", "glslang\OSDependent"),
        ("KrayoDeps", "hlsl\HLSL"),
        ("KrayoDeps", "glslang\OGLCompiler"),
        ("KrayoDeps", "SPIRV-Tools libraries\SPIRV-Tools"),
        ("KrayoDeps", "glslang\glslang"),
        ("KrayoDeps", "SPIRV-Tools libraries\SPIRV-Tools-opt"),
        ("KrayoDeps", "glslang\SPIRV"),
        ("KrayoDeps", "shaderc_util"),
        ("KrayoDeps", "shaderc"),
        ("KrayoDeps", "KrayoDepsPostBuild")
    ]
